...
class RequestService
{
     ...
     */
    public function unserializeData(string $content, string $contentType): array
    {
     ...
     */
    public function checkUserScopes(array $references, string $type = 'schemas'): ?Response
    {
     ...
     * @return void
     */
    public function handleMetadataSelf(array &$result, ?Source $proxy = null)
    {
